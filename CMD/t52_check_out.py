...
home_url = "/home/huyheo/work/Project/T52"
...
def clean_build():
    ...
    print " svn co http://svn.humaxdigital.com/drr_cdi/trunk/models/t52/ ./"
    os.system("svn co http://svn.humaxdigital.com/drr_cdi/trunk/models/t52/ ./")
   
    new_home_url = os.path.join(home_url,"model","down");
